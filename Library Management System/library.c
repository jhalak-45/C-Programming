...
#define FILE_NAME  "EECLibraryInformation.txt"
...
void headMessage(const char *message)
{
    ...
    printf("\t\t\t#############################################################################");
    printf("\n\t\t\t############                                                     ############");
    printf("\n\t\t\t############    Everest  Library Information System              ############");
    printf("\n\t\t\t############              -By Jhalak Dhami                       ############");
    printf("\n\t\t\t#############################################################################");
    printf("\n\t\t\t---------------------------------------------------------------------------\n");
...
void welcomeMessage()
{
    headMessage("EEC Library Information System ");
    printf("\n\n\n\n\n");
    printf("\n\t\t\t  **-**-**-**-**-**-**-**-**-**-**-**-**-**-**-**-**-**-**\n");
    printf("\n\t\t\t        =-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=");
    printf("\n\t\t\t        =                 WELCOME                   =");
...
void viewBooks()
{
    ...
    while (fread (&addBookInfoInDataBase, sizeof(addBookInfoInDataBase), 1, fp))
    {
        ...
        printf("\t\t\tBook Author's Name: %s",addBookInfoInDataBase.authorName);
...
void init()
{
    FILE *fp = NULL;
    int status = 0;
    const char defaultUsername[] ="eeclibrary\n";
    const char defaultPassword[] ="eeclibrary123\n";
    sFileHeader fileHeaderInfo = {0};
